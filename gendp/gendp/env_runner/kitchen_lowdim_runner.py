...
from gendp.policy.base_lowdim_policy import BaseLowdimPolicy
from gendp.common.pytorch_util import dict_apply
from gendp.env_runner.base_lowdim_runner import BaseLowdimRunner
...
class KitchenLowdimRunner(BaseLowdimRunner):
    def __init__(self,
        ...
        def env_fn():
            from gendp.env.kitchen.v0 import KitchenAllV0
            from gendp.env.kitchen.kitchen_lowdim_wrapper import KitchenLowdimWrapper
