from gendp.model.common.normalizer import SingleFieldLinearNormalizer
from gendp.common.pytorch_util import dict_apply, dict_apply_reduce, dict_apply_split
import numpy as np


def get_range_normalizer_from_stat(stat, output_max=1, output_min=-1, range_eps=1e-7, ignore_dim=None):
    # -1, 1 normalization
    input_max = stat['max']
    input_min = stat['min']
