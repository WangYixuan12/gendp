...
if scene == 'mug':
    data_path = f'{curr_path}/data/2023-09-15-13-21-56-171587' # mug
    pca_path = f'{curr_path}/d3fields/pca_model/mug.pkl'
    query_texts = ['mug']
    query_thresholds = [0.3]
elif scene == 'fork':
    data_path = f'{curr_path}/data/2023-09-15-14-15-01-238216' # fork
    pca_path = f'{curr_path}/d3fields/pca_model/fork.pkl'
    query_texts = ['fork']
    query_thresholds = [0.25]
elif scene == 'shoe':
    data_path = f'{curr_path}/data/2023-09-11-14-15-50-607452' # shoe
    pca_path = f'{curr_path}/d3fields/pca_model/shoe.pkl'
    query_texts = ['shoe']
...
fusion = Fusion(num_cam=4, feat_backbone='dinov2', dtype=dtype)
