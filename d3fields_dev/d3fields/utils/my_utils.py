...
def test_voxel_downsample():
    ...
    voxel_size = 0.1
    downpcd = voxel_downsample(init_pcd, voxel_size)
    print('downpcd', downpcd.shape)
    
    init_pcd_o3d = np2o3d(init_pcd)
    downpcd_o3d = np2o3d(downpcd)
    o3d.visualization.draw_geometries([init_pcd_o3d])
    o3d.visualization.draw_geometries([downpcd_o3d])
